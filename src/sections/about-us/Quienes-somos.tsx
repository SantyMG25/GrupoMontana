...
export default function NostrosHero() {
    return (
            ...
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-14 px-6 lg:flex-row lg:gap-20">
                ...
                <div className="w-full lg:w-[55%">
                    ...
                    <p className="mt-6 max-w-xl text-base leading-relaxed text-gray-500 md:text-lg">
                        Somos una empresa enfocada en remodelación y adecuación de espacios en Bogotá y sus alrededores.
                    ...
                    <div className="nt-8 flex flex-col gap-4 sm:flex-row px-[150px]" >
                        <WtpButton />
                    </div>
                </div>
